    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="service-center-row<?php echo $service_center_row; ?>">
            <tr>
              <td class="left"><select name="service-center[<?php echo $module_row; ?>][layout_id]">
