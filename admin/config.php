<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/~irischan/dssit-shop/admin/');
define('HTTP_CATALOG', 'http://localhost/~irischan/dssit-shop/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/~irischan/dssit-shop/admin/');
define('HTTPS_CATALOG', 'http://localhost/~irischan/dssit-shop/');

// DIR
define('DIR_APPLICATION', '/Users/irischan/Sites/dssit-shop/admin/');
...
define('DIR_LANGUAGE', '/Users/irischan/Sites/dssit-shop/admin/language/');
define('DIR_TEMPLATE', '/Users/irischan/Sites/dssit-shop/admin/view/template/');
...
define('DIR_CATALOG', '/Users/irischan/Sites/dssit-shop/catalog/');
