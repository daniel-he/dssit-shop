...
class ControllerSysaidTicket extends Controller {
	...
	public function index() {   
		$this->language->load('sysaid/ticket');
		...
		$this->data['button_add_subcategory'] = $this->language->get('button_add_subcategory');
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('sysaid/ticket', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('sysaid/ticket', 'token=' . $this->session->data['token'], 'SSL');
