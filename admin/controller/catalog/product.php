...
class ControllerCatalogProduct extends Controller {
  ...
  protected function getForm() {
    ...
    if (isset($this->error['sysaid_category'])) {
      $this->data['error_sysaid_category'] = $this->error['sysaid_category'];
    } else {
    ...
    if (isset($this->request->post['sysaid_category'])) {
      $this->data['sysaid_category'] = $this->request->post['sysaid_category'];
    } elseif (!empty($product_info)) {
